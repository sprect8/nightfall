...
beforeAll(async () => {
  ...
  commitmentAliceC = utils.concatenateThenHash(erc20AddressPadded, amountC, publicKeyA, saltAliceC);
  commitmentAliceD = utils.concatenateThenHash(erc20AddressPadded, amountD, publicKeyA, saltAliceD);
